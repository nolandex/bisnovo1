...
interface Product {
  ...
  imageUrl?: string; // Replaced features with imageUrl
  exampleUrl?: string;
      ...
      <div className="container max-w-4xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-4 mb-6">
          <button
            ...
            className={getButtonClasses(activeCategory === "landing_page")}
          >
            Landing Page
          </button>
          <button
            onClick={() => setActiveCategory("portfolio")}
            className={getButtonClasses(activeCategory === "portfolio")}
          >
            Portfolio
          </button>
          <button
            onClick={() => setActiveCategory("profil_bisnis")}
            className={getButtonClasses(activeCategory === "profil_bisnis")}
          >
            Profil Bisnis
          </button>
        </div>

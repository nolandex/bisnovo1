    ...
    <section id='faq' className='relative py-10 md:py-20 overflow-hidden'>
      ...
      >
        <div className='relative z-10 flex flex-col gap-5 items-start mb-10 px-4 md:px-6'>
          ...
          <h3 className='font-bold text-3xl md:text-5xl bg-gradient-to-r from-base-content from-50% to-[#9c9c9c] text-left bg-clip-text text-transparent !leading-[1.25em]'>
            {locale.h3}
          </h3>
        </div>
      </motion.div>
